...
type MetricsServiceClient interface {
	SendMetric(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*Empty, error)
	GetMetrics(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MetricsList, error)
}
...
func (c *metricsServiceClient) SendMetric(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *metricsServiceClient) GetMetrics(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MetricsList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MetricsList)
...
type MetricsServiceServer interface {
	SendMetric(context.Context, *Metric) (*Empty, error)
	GetMetrics(context.Context, *Empty) (*MetricsList, error)
...
func (UnimplementedMetricsServiceServer) SendMetric(context.Context, *Metric) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendMetric not implemented")
}
func (UnimplementedMetricsServiceServer) GetMetrics(context.Context, *Empty) (*MetricsList, error) {
...
func _MetricsService_SendMetric_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).SendMetric(ctx, req.(*Metric))
	}
